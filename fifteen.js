...
Name: Samantha Riley
ID: 620053985
Special feature implemented: end-of-game notification for winning
*/
...
window.onload = function ()
{
	...
	//puzzlearea.style.backgroundImage="url('rubixcube.png')";
	...
	for (var i=0; i<div.length; i++)
	{
		...
		div[i].onmouseover = function()
		{
			if (checkCanMove(parseInt(this.innerHTML)))
			{
                ...
                this.style.backgroundImage="url('rubixcube.png')"; 
